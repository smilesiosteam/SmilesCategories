...
class RecommendedResturantCollectionViewCell: UICollectionViewCell {
    ...
    private func setupUI() {
        ...
        ratingLbl.fontTextStyle = .smilesTitle3
        ratingLbl.textColor = .black
        
        timeLbl.fontTextStyle = .smilesTitle3
    ...
    func configureCellWithData(data : Restaurant) {
        ...
        image.setImageWithUrlString(data.imageUrl.asStringOrEmpty()) { [weak self] image in
            if let image = image {
